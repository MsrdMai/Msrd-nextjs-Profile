...
const EducationSection: FC = () => {
	const educationList: Education[] = [
		{
			academy: 'King Mongkut’s institute of technology ladkrabang',
			program: 'Bachelor of Science Program in Information Technology',
			description: 'Graduated June 2022',
			link: '/files/msrd_portfolio.pdf',
		},
		{
			academy: 'SatriWatRakhang School',
			program: 'Chinese and english program',
			description: 'Graduated April 2018',
			link: '/files/msrd_portfolio_school.pdf',
		},
	]

	return (
		<>
			<span className="relative text-3xl font-normal text-rose-600 bg-rose-100 rounded-full px-4 py-2 transition-all dark:text-gray-900">
				Education

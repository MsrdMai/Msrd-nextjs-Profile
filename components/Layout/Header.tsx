				...
				<div className="container mx-auto flex max-w-5xl flex-wrap items-center justify-between">
					...
					<div className="hidden w-full md:block md:w-auto" id="mobile-menu">
						<ul className="flex flex-col md:mt-0 md:flex-row md:items-center md:space-x-8 md:text-sm md:font-medium">
							...
							<li>
								<div
									className="block cursor-pointer border-b border-gray-100 py-3 px-4 p-2 rounded-lg bg-pink-600 text-white transition-all hover:bg-gray-50 hover:border-pink-600 hover:border-2 hover:text-pink-600 dark:border-gray-700 dark:text-gray-700 dark:bg-gray-50 dark:hover:bg-gray-200 dark:hover:text-gray-500 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-gray-900 md:dark:hover:bg-transparent md:dark:hover:text-white"
									onClick={() =>
										(window.location.href =
											'https://github.com/sanviiz/sanviiz.github.io/tree/develop/')
									}
								>
									<span className="py-8 px-4 m-2">Source</span>
								</div>
							</li>
							<li>
								<div
								...
								>
									<span className="py-8 px-4 m-2">Contact</span>
								</div>
							</li>
						</ul>
					</div>
